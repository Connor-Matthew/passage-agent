...
class Settings(BaseSettings):
    ...
    # AI 配置（第 3 期新增，第 10 期重构为通用 OpenAI 兼容格式）
    openai_api_key: str = ""
    openai_api_base: str = "https://api.openai.com/v1"
    openai_model: str = "gpt-4o-mini"

    # 兼容旧配置（阿里云 DashScope，第 3 期遗留）
    dashscope_api_key: str = ""
    dashscope_model: str = "qwen-plus"

    # Qwen Image / 通义千问生图
    qwen_image_model: str = "qwen-image-2.0-pro"
    qwen_image_negative_prompt: str = "低分辨率，低画质，肢体畸形，手指畸形，画面过饱和，蜡像感，人脸无细节，过度光滑，画面具有AI感。构图混乱。文字模糊，扭曲。"
    qwen_image_prompt_extend: bool = True
    qwen_image_watermark: bool = False
    qwen_image_size: str = "2048*2048"
    qwen_image_timeout: int = 180
